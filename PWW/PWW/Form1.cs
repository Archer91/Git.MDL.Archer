...
namespace PWW
{
    public partial class Form1 : Form
    {
        ...
        //{
        //    dtTooth = new DataTable();
        //    dtTooth.Columns.Add("Job Order");
        //    dtTooth.Columns.Add("项目编号");
        //    dtTooth.Columns.Add("项目名称");
        //    dtTooth.Columns.Add("折算比率");
        //    dtTooth.Columns.Add("计数类型");
        //    dtTooth.Columns.Add("实际牙数");
        //    dtTooth.Columns.Add("责任计算");
        //    dtTooth.Columns.Add("牙位");
        //    dtTooth.Columns.Add("折后牙数");
        //    dtTooth.Columns.Add("关联记录");
        //    dtTooth.Columns.Add("备注栏");
        //    int Rd = 0;
        //}
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (Save_Data()) //工号
            {
                ...
                if (txtcounttype.Text == "1")
                {
                    dgvTooth.Rows[index].Cells[7].Value = "新做";
                }
                else if (txtcounttype.Text == "2")
                {
                    dgvTooth.Rows[index].Cells[7].Value = "修补";
                }
                else
                {
                    dgvTooth.Rows[index].Cells[7].Value = "重做";
                }
                ...
                //dgvTooth.Rows[index].Cells[11].Value = dateTimePicker1.Text;//string.Format("{0:yyyy-MM-dd HH:mm:ss}", dateTimePicker1.Value)
                ...
                dgvTooth.Rows[index].Cells[14].Value = combDept.SelectedValue.ToString();
                dgvTooth.Rows[index].Cells[15].Value = combWorkType.SelectedValue.ToString();
                if (index > 15)
                {
                    dgvTooth.FirstDisplayedScrollingRowIndex = index - 15;
                ...
                //change by yf 20140108 no loop directly add 
                //int count = 0;
                ...
                labeltotalcount.Text = (Convert.ToInt32(labeltotalcount.Text) + Convert.ToInt32(dgvTooth.Rows[index].Cells[3].Value.ToString())).ToString();
        ...
        private void btnModify_Click(object sender, EventArgs e)
        {
            ...
            if (Save_Modify())
            {
                ...
                {
                    if (dgvTooth.Rows[igc].Cells[12].Value.ToString() == gloabsequence)
                    {
                        index = igc;
                        break;
                    }
        ...
        private void dgvTooth_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvTooth.Rows[e.RowIndex].Cells[7].Value.ToString() == "新做")
            {
                txtcounttype.Text = "1";
                txtcounttypename.Text = "新做";
            }
            else if (dgvTooth.Rows[e.RowIndex].Cells[7].Value.ToString() == "修补")
            {
                txtcounttype.Text = "2";
                txtcounttypename.Text = "修补";
            }
            ...
            combDept.SelectedValue = dgvTooth.Rows[e.RowIndex].Cells[14].Value;
            combWorkType.SelectedValue = dgvTooth.Rows[e.RowIndex].Cells[15].Value.ToString();
