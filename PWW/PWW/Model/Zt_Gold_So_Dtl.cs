...
namespace PWW.Model
{
	public partial class Zt_Gold_So_Dtl : IDataGridRowCellValueChange, IEditableObject
	{
		struct SData
		{
			...
			internal string zgsod_5_is_pfm;
		...
		public string Zgsod_5_Is_Pfm
		{
			get { return cData.zgsod_5_is_pfm; }
			set { cData.zgsod_5_is_pfm = value; }
		}
		...
		void IEditableObject.EndEdit()
		{
			if (inTxn)
			{
				...
				if (cData.zgsod_5_is_pfm != backupData.zgsod_5_is_pfm) _CellValueChange += "," + "Zgsod_5_Is_Pfm";
		...
		public static Zt_Gold_So_Dtl N
		{
			get
			{
				return new Zt_Gold_So_Dtl();
			}
		}
		...
		public partial class Where
		{
			...
			public Where Zgsod_5_Is_Pfm(string value)
			{
				string s = ZOra.GetWhere1("Zgsod_5_Is_Pfm", value, "float");
				if (s != "") ls.Add(s);
				return this;
			}
