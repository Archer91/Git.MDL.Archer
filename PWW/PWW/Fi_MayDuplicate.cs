...
namespace PWW
{
    public partial class Fi_MayDuplicate : Form
    {
        public Fi_MayDuplicate()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strbSql.Append(@"select DISTINCT JOME_JOBNO,JOME_WKIT_CODE,WKIT_DESCRIPTION,JOME_QTY,JOME_EFF_QTY,nvl(JOME_EFF_QTY,0)-nvl(JOME_REWORK_EFF_QTY,0) JOME_TOT_EFF_QTY,(nvl(JOME_EFF_QTY,0)-nvl(JOME_REWORK_EFF_QTY,0))*nvl(WKTP_PRICE,0) JOME_TOT_EFF_AMT,JOME_DEPT_CODE,DEPT_DESCRIPTION,JOME_WKTP_CODE,WKTP_DESCRIPTION,JOME_DATE,JOME_EMP_CODE,EMP_NAME,JOME_WPOS_CODE,
DECODE(JOME_ME_TYPE,'1','1-新做','2','2-修补','3','3-重做',JOME_ME_TYPE) JOME_ME_TYPE,JOME_REPF_CODE,REPF_DESCRIPTION,JOME_TOOTH_POSITION,JOME_REWORK_REASON,JOME_REWORK_QTY,JOME_REWORK_EFF_QTY,nvl(JOME_GROUP_NO,WPOS_GROUP_NO) JOME_GROUP_NO,JOME_WKIT_COUNT_TYPE,JOME_WKIT_RATE,JOME_CRT_ON,JOME_CRT_BY,JOME_UPD_ON,JOME_UPD_BY 
from
(select a1.* from 
(select jome_dept_code,jome_jobno,jome_date,jome_wktp_code,jome_wkit_code,jome_wpos_code,jome_me_type from ztpw_jome_jobmanueff 
   where  jome_status='1' ");
                strbSql_deduct.Append(@"select DISTINCT JODE_JOBNO JOME_JOBNO,JODE_DEIT_CODE JOME_WKIT_CODE,DEIT_DESCRIPTION,0 JOME_QTY,0 JOME_EFF_QTY,-nvl(JODE_EFF_QTY,0)-nvl(JODE_REWORK_EFF_QTY,0) JOME_TOT_EFF_QTY,(-nvl(JODE_EFF_QTY,0)-nvl(JODE_REWORK_EFF_QTY,0))*nvl(WKTP_PRICE,0) JOME_TOT_EFF_AMT,
JODE_DEPT_CODE JOME_DEPT_CODE,DEPT_DESCRIPTION,JODE_WKTP_CODE JOME_WKTP_CODE,WKTP_DESCRIPTION,JODE_DATE JOME_DATE,JODE_EMP_CODE JOME_EMP_CODE,EMP_NAME,JODE_WPOS_CODE JOME_WPOS_CODE,
DECODE(JODE_ME_TYPE,'1','1-新做','2','2-修补','3','3-重做',JODE_ME_TYPE) JOME_ME_TYPE,JODE_REPF_CODE JOME_REPF_CODE,REPF_DESCRIPTION,JODE_TOOTH_POSITION JOME_TOOTH_POSITION,JODE_REWORK_REASON JOME_REWORK_REASON,JODE_QTY JOME_REWORK_QTY,JODE_EFF_QTY JOME_REWORK_EFF_QTY,nvl(JODE_GROUP_NO,WPOS_GROUP_NO) JOME_GROUP_NO,
JODE_DEIT_COUNT_TYPE JOME_WKIT_COUNT_TYPE,JODE_DEIT_RATE JOME_WKIT_RATE,JODE_CRT_ON JOME_CRT_ON,JODE_CRT_BY JOME_CRT_BY,JODE_UPD_ON JOME_UPD_ON,JODE_UPD_BY JOME_UPD_BY 
from
(select b1.* from 
(select jode_dept_code,jode_jobno,jode_date,jode_wktp_code,jode_deit_code,jode_wpos_code,jode_me_type from ztpw_jode_jobdeducteff 
   where  jode_status='1' ");
                ...
                {
                    strbSql.Append(" and nvl(jome_group_no,' ')  = '" + cbx_groupno.SelectedValue.ToString() + "'");
                    strbSql_deduct.Append(" and nvl(jode_group_no,' ')  = '" + cbx_groupno.SelectedValue.ToString() + "'");
                }

                strbSql.Append(@" group by jome_dept_code,jome_jobno,jome_date,jome_wktp_code,jome_wkit_code,jome_wpos_code,jome_me_type
having count(jome_dept_code) >1) a2,
ztpw_jome_jobmanueff a1
where a2.jome_jobno=a1.jome_jobno   
  and a2.jome_dept_code=a1.jome_dept_code 
  and a2.jome_wktp_code=a1.jome_wktp_code 
  and a2.jome_wkit_code=a1.jome_wkit_code 
  and a2.jome_wpos_code=a1.jome_wpos_code 
  and a2.jome_date=a1.jome_date
  and a2.jome_me_type=a1.jome_me_type
 ) aa1,ZTPW_EMP_EMPLOYEE,ZTPW_WPOS_WORKPOSITION,ZTPW_WKIT_WORKITEM,ZTPW_WKTP_CRAFT,ZTPW_REPF_RESP_FORMULA,ZTPW_DEPT_INFO
where jome_emp_code=emp_code(+)
  ...
  and nvl(jome_status,'1')='1' ");
                strbSql_deduct.Append(@" group by jode_dept_code,jode_jobno,jode_date,jode_wktp_code,jode_deit_code,jode_wpos_code,jode_me_type
having count(jode_dept_code) >1) b2,
ztpw_jode_jobdeducteff b1
where b2.jode_jobno=b1.jode_jobno  
  and b2.jode_dept_code=b1.jode_dept_code 
  and b2.jode_wktp_code=b1.jode_wktp_code 
  and b2.jode_deit_code=b1.jode_deit_code 
  and b2.jode_wpos_code=b1.jode_wpos_code 
  and b2.jode_date=b1.jode_date
  and b2.jode_me_type=b1.jode_me_type
 ) bb1,ZTPW_EMP_EMPLOYEE,ZTPW_WPOS_WORKPOSITION,ZTPW_DEIT_DEDUCTITEM,ZTPW_WKTP_CRAFT,ZTPW_REPF_RESP_FORMULA,ZTPW_DEPT_INFO
where jode_emp_code=emp_code(+)
  ...
  and nvl(jode_status,'1')='1'  ");
                ...
                //20140613 by yf add deduct info   
                //"order by jome_jobno,jome_wpos_code,jome_wkit_code,jome_date";

                //DataSet dsJome = DB.GetDSFromSql(strbSql.ToString());
                DataSet dsJome = DB.GetDSFromSql("select * from ( " + strbSql.ToString() + " union " + strbSql_deduct.ToString() + " ) tta order by jome_jobno,jome_wpos_code,jome_wkit_code,jome_date");
        ...
        private void Fi_InqGeneral_SizeChanged(object sender, EventArgs e)
        {
            int height = 571, width = 984;
