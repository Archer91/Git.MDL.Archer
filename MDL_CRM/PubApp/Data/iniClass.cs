...
namespace PubApp.Data
{
    ...
    public class iniCls
    {
                                ...
                                string defaultValue)
        {
            ...
            StringBuilder retval = new StringBuilder(iniCls.MaxSectionSize);

            NativeMethods.GetPrivateProfileString(sectionName,
                                                  keyName,
                                                  defaultValue,
                                                  retval,
                                                  iniCls.MaxSectionSize,
                                                  m_path);
        ...
        public List<KeyValuePair<string, string>> GetSectionValuesAsList(string sectionName)
        {
            ...
            IntPtr ptr = Marshal.AllocCoTaskMem(iniCls.MaxSectionSize);
