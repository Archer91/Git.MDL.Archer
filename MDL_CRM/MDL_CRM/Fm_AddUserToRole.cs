...
namespace MDL_CRM
{
    public partial class Fm_AddUserToRole : Form
    {
        ...
        {
            string sqlStr = "select role_code,role_description,case role_status when '1' then '有效' else '失效' end role_status from ZT00_ROLE_INFO where  role_code like 'R_MDLCRM%'";
